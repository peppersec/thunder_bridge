...
async function checkWorker() {
  try {
    ...
    fs.appendFileSync(
      path.join(__dirname, '/responses/getBalances.dat'),
      linearize(status, prefix, separator)
    ...
    fs.appendFileSync(
      path.join(__dirname, '/responses/validators.dat'),
      linearize(vBalances, prefix, separator)
